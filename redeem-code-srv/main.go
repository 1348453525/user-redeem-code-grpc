...
import (
	...
	"github.com/1348453525/user-redeem-code-grpc/redeem-code-srv/handler"
	"github.com/1348453525/user-redeem-code-grpc/redeem-code-srv/initialize"
	"github.com/1348453525/user-redeem-code-grpc/redeem-code-srv/pkg/util"
...
func main() {
	...
	if err != nil {
		zap.S().Fatalw("获取空闲端口失败", "error", err) // 记录日志并退出
	}
	...
	// 注册用户服务
	proto.RegisterRedeemCodeServer(server, &handler.RedeemCode{})
	// 注册健康检查服务
